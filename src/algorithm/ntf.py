...
class NTFbase:
    ...
    def __call__(self, *args, **kwargs):
        ...
        Z, T, V = self.partitioning, self.base, self.activation
    ...
    def update(self, target, iteration=100):
        ...
        self.partitioning = np.random.rand(n_channels, n_bases)
...
class EUCNTF(NTFbase):
    def __init__(self, n_bases, eps=EPS):
    ...
    def update_once(self):
        ...
        self.partitioning, self.base, self.activation = Z, T, V
